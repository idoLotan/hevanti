...
const Carousel = () => {
  return (
    <div className="flex items-center">
      ...
      <div className="relative left-10 top-40 w-40 hidden lg:block">
        <svg

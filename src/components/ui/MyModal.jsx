          ...
          <div>
            ...
            >
              <div className="relative h-full w-full max-w-lg p-4 md:h-auto">
                <div className="relative  flex h-[50vh] max-h-[100rem] min-h-[20rem]  w-[50rem]  animate-fade-up flex-col items-center  justify-center rounded-lg bg-neutral-100 shadow dark:bg-gray-800 md:p-2 ">
                  <div className="flex">
                    <svg
                      role="presentation"
                  ...
                  <div
                    dir="rtl"
                    className=" w-96 text-center text-xl font-medium leading-10 text-indigo-600"
                  >
                    אנו מעריכים את התעניינותך בשירותים שלנו.
                    <br /> נציגנו ייצור איתך קשר בהקדם כדי לדון בפרטים ולענות על
                    כל השאלות שלך.
                  </div>
                  ...
                  <div className=" mt-10   flex flex-row justify-evenly">
                    ...
                    <button className=" m-1  flex h-10 w-60 items-center justify-center rounded-xl bg-orange-500 text-center text-base font-bold text-neutral-100">
                      <img
                        src={phone}
                    ...
                    <button
                      ...
                      className=" m-1  flex h-10 w-60 items-center justify-center rounded-xl bg-orange-500 text-center text-base font-bold text-neutral-100"
                    >
                      <img
                        src={whatapp}
                        className="w-10 cursor-pointer  rounded-xl border-8 border-orange-500 bg-orange-500"

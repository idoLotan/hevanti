...
function Home() {
  ...
  return (
    <div>
      ...
      <section
        className="section-1 h-[1100px] bg-cover bg-no-repeat md:h-[100vh]"
        id="home"
      >
...
<rect x="48" y="31" width="8" height="2" fill="#555FD9"/>
      ...
      >
        <div className="flex flex-row md:flex-col items-center">
          ...
          <div className="h-[119px] flex-col m-3 flex items-center group justify-center w-[181px] border-2 border-[#FF7848] hover:border-[#555FD9]">
...
<path d="M10.8499 33.3332C10.8499 34.3004 10.0492 35.111 9.02849 35.111C8.00776 35.111 7.20703 34.3004 7.20703 33.3332C7.20703 32.366 8.00776 31.5554 9.02849 31.5554C10.0492 31.5554 10.8499 32.366 10.8499 33.3332Z" fill="#555FD9" stroke="#555FD9" stroke-width="2"/>
          ...
          <div className="h-[119px] flex-col m-3 flex items-center group justify-center w-[181px] border-2 border-[#FF7848] hover:border-[#555FD9]">
          <svg xmlns="http://www.w3.org/2000/svg"  width="60"  className="mt-2 " height="72" viewBox="0 0 64 72" fill="none">

...
function Home() {
  ...
  return (
    <div>
      ...
      <div>
         <img src={phoneBtn}  className=" md:hidden fixed bottom-10 left-10 z-30  w-[74px]" alt="" />
            ...
            <div className="relative flex flex-col justify-around md:flex-row">
              ...
              <div className="mt-11 flex flex-col pt-0 md:pt-12">
                <h1 className=" font-montserrat text-right text-[42px] font-bold text-[#2A264D]">
                  <p className="">התחל\י את המסע ההצלחה</p>
                  <p className="flex items-center justify-end ">
                  <svg xmlns="http://www.w3.org/2000/svg" className="p-1" width="130"  viewBox="0 0 84 38" fill="none">
...
<rect x="48" y="31" width="8" height="2" fill="#555FD9"/>
      ...
      >
        ...
        <div className="flex flex-row md:flex-col items-center">
          ...
          <div className="h-[119px] cursor-pointer flex-col m-3 pt-3 flex items-center group justify-center w-[181px] border-2 border-[#FF7848] hover:border-[#555FD9]">

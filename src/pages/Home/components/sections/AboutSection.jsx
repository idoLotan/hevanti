    ...
    <div>
      <section className="about-bg  relative" id="about">
        <div className="  relative  flex  flex-col   items-center  justify-around  p-6 md:flex-row">
          <div className="Rectangle100 relative animate-fade-right  order-1 mb-4 text-[14px] md:text-[16px]   flex  w-[90%] flex-col items-end  rounded-br-[46px] rounded-tl-[46px] bg-[#555FD9] bg-opacity-20 p-2    md:bottom-28  md:w-[560px] md:h-[280px] 2xl:bottom-28   2xl:min-w-[660px]">
          ...
          <div className="relative order-2 flex flex-col  items-end  md:order-1 ">
            <div className=" order-2 flex flex-col  items-end justify-center p-5 md:h-auto">
              <img
                alt="ofer"
                className="animate-fade-left mr-0 hidden min-w-[270px] rounded-xl md:block  md:h-[450px] md:w-[300px] 2xl:h-[590px] 2xl:w-[386px]"
                src={ofer}
              />
              <img
                alt="ofer"
            ...
            <div className=" animate-fade-left oreder-1 absolute  bottom-3  hidden    h-[185px] w-[615px] p-4 text-right  text-[20px] font-medium   leading-loose text-neutral-100 md:right-[240px] md:order-2 md:block  md:w-[545px] 2xl:right-[340px] 2xl:h-[185px] 2xl:w-[615px]">

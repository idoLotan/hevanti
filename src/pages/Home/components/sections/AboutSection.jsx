        ...
        <div className="  relative  flex  flex-col   items-center  justify-around  p-6 md:flex-row">
          ...
          <div className="relative order-2 flex flex-col  items-end  md:order-1 ">
            <div className=" order-2 flex flex-col  items-end justify-center p-5 md:h-auto">
              <img
                alt="ofer"
                className="mr-0 hidden min-w-[270px] animate-fade-left rounded-xl md:block  md:h-[450px] md:w-[300px] 2xl:h-[590px] 2xl:w-[386px]"
                src={ofer}
              />
              <img
                alt="ofer"
            ...
            <div className=" oreder-1 absolute bottom-3  hidden  h-[185px]    w-[615px] animate-fade-left p-4 text-right  text-[20px] font-medium   leading-loose text-neutral-100 md:right-[240px] md:order-2 md:block  md:w-[545px] 2xl:right-[340px] 2xl:h-[185px] 2xl:w-[615px]">
              <img
                alt="ofer"

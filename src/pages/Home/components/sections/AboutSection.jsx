...
const AboutSection = () => {
  ...
  return (
    <div>
      <section ref={ref} className={` about-bg  relative 2xl:h-[48rem]`} id="about">
   
        <div  className={`  relative  flex  flex-col   items-center  justify-around  p-6 md:flex-row`}>
          <div className={`${inView ? "block" : "md:hidden"}  relative order-1  mb-4 flex w-[90%] animate-fade-right   flex-col  items-end rounded-br-[46px] rounded-tl-[46px]  bg-[#555FD9] bg-opacity-20 p-2 text-[14px] md:bottom-28    md:h-[280px]  md:w-[560px] md:text-[16px] 2xl:bottom-28   2xl:min-w-[660px]`} >
            <img
          ...
          <div className="relative order-2 flex flex-col  items-end  md:order-1 ">
            <div className=" order-2 flex flex-col  items-end justify-center p-5 md:h-auto">
              <img
                alt="ofer"
                className={`${inView ? "block" : "md:hidden"} mr-0 hidden min-w-[270px] animate-fade-left rounded-xl md:block  md:h-[450px] md:w-[300px] 2xl:h-[590px] 2xl:w-[386px]`}
                src={ofer}
              />   
              <img
                alt="ofer"
            ...
            <div className={`${inView ? "block" : "md:hidden"} oreder-1 absolute bottom-3  hidden  h-[185px]    w-[615px] animate-fade-left p-4 text-right  text-[20px] font-medium   leading-loose text-neutral-100 md:right-[240px] md:order-2 md:block  md:w-[545px] 2xl:right-[340px] 2xl:h-[185px] 2xl:w-[615px]`} >
              <img
                alt="ofer"
                className="absolute left-[-10rem] top-[0rem] 2xl:top-[-5rem]  w-24"
                src={arrow}
              />

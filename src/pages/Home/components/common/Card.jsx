...
const Card = ({
  ...
  return (
    <div className="   group  relative m-3  flex h-[470px]   w-[272px]    min-w-[272px]  transform-gpu  cursor-pointer flex-col items-center overflow-hidden rounded-md border border-indigo-700 border-opacity-30 bg-[#3F48B4] bg-opacity-0 p-2  font-semibold shadow  duration-150 hover:translate-y-[-4px] hover:border-indigo-700 hover:border-opacity-100 hover:bg-indigo-600 hover:bg-opacity-10 hover:shadow-md  ">
      <div className=" flex">
      ...
      <div className="relative w-full">
        {popular && (
          <div className=" absolute right-3 h-6 w-24 -rotate-12 border-2 border-red-500 text-center text-sm font-bold leading-normal text-red-500">
            הכי פופולרי
          </div>
        )}
      </div>
